...
<div class="form-group <?php if(isset($e['Nom'])){if(!empty($e['Nom'])){echo 'has-error';}}elseif ( isset($e["pasvalidenom"])) { echo 'has-error'; }?>">
<label>Nom</label>
...
<div class="form-group <?php if(isset($e['Prenom'])){if(!empty($e['Prenom'])){echo 'has-error';}}elseif ( isset($e["pasvalideprenom"])) { echo 'has-error'; }?>">
<label>Prénom</label>
...
<div class="form-group <?php if(isset($e['email'])){if(!empty($e['email'])){echo 'has-error';}}elseif ( isset($e["pasvemail"])) { echo 'has-error'; }?>">
...
<div class="form-group <?php if(isset($e['datenaissance'])){if(!empty($e['datenaissance'])){echo 'has-error';}} elseif ( isset($e["pasvalide"])) { echo 'has-error'; }?>">
...
<div class="form-group <?php if(isset($e['adresse'])){if(!empty($e['adresse'])){echo 'has-error';}}elseif ( isset($e["pasvalideadresse"])) { echo 'has-error'; }?>">
<label>Adresse</label>
