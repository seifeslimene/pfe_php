...
if(isset($_POST))
{
	if(!empty($_POST))
	{
		...
		var_dump ($ref_personne);
		$req_ajout_emp = "INSERT INTO `employe`
									( 	`MATRICULE`,
										`REFPERSONNEE`)
								 VALUES   ('".$matricule."',
										  ".$ref_personne."
...
<head>
  <meta charset="UTF-8" />
	...
	<title>Ajout D'un Employ&eacute;</title>
...
<div class="menubar">
	...
	<div class="page-title">
			<strong>Ajout D'un Employ&eacute;</strong>
	</div>
</div>

<div class="content-wrapper">
<div class="content-wrapper"><a href="Affichage_Employe.php" class="btn btn-primary">Liste Des Employ&eacute;s</a></div>
