 ...
 <body id="dashboard">	
   ...
   <div id="sidebar-default" class="main-sidebar fix-scroll">
    <div class="current-user">
     <a href="#" class="name">
      <img alt="1" class="avatar" src="images/employee.png" />
      <span>Employé
   ...
   <div id="content">
    <div class="menubar">
	   ...
	   <div class="page-title">
		  <strong><h4 style="margin-top:0px;"><font color="green" face="monotype corsive" size="5">Bienvenue Employé</font></H4></strong>
	   </div>
    </div>
