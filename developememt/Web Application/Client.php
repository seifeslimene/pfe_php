...
$req_emp = "select 
			...
			join
				client 
			where 
				client.REFPERSONNE = personne.ID
			";
	...
	<table  class="table">
        <thead>
            <tr>
                ...
                <th tabindex="0" rowspan="1" colspan="1">Prenom
                </th>
				...
				<th tabindex="0" rowspan="1" colspan="1">Matricule Fiscale
                </th>
		...
		<?php foreach($data as $d) {?>
            <tr>
				...
				<td><?php echo $d['MATRICULEFISCALE'];?></td>
				<td><a href="Modifier_Client.php?id_client=<?php echo $d['ID'];?>" class="btn btn-info">Modifier</a></td>
				<td><a href="Supp_Client.php?id_client=<?php echo $d['ID'];?>" class="btn btn-danger">Supprimer</a></td>
