...
<div class="content-wrapper">
	...
	<table  class="table">
		...
		<?php foreach($data as $d) {?>
            <tr>
                <td><?php echo $d['Nom_Proj'];?></td>
				<td><i><?php echo $d['Description_Proj'];?></i></td>
				<td><a href="Ajout_Tache.php?id_projet=<?php echo $d['ID'];?>" class="btn btn-success">Ajout T&acirc;che</a></td>
                <td><a href="Affichage_Taches.php?id_projet=<?php echo $d['ID'];?>" class="btn btn-warning">Liste T&acirc;ches</a></td>
				<td><a href="Modifier_Projet.php?id_projet=<?php echo $d['ID'];?>" class="btn btn-info">Modifier</a></td>
				<td><a href="Supp_Projet.php?id_projet=<?php echo $d['ID'];?>" class="btn btn-danger">Supprimer</a></td>	
            </tr>
         <?php }?>
