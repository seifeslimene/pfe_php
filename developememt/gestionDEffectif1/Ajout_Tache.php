 ...
 if(!empty($_GET['id_projet']))
 {
   ...
   if(isset($_POST))
   {
	if(!empty($_POST))
	{
		...
		header('location:Liste_Taches.php?id_projet='.$id_projet);
		}
		}
		}
		 }
...
<div class="content-wrapper"><a href="Liste_Taches.php?id_projet=<?php echo $id_projet ?>" class="btn btn-primary">Liste Des T&acirc;ches</a></div>
