...
if(isset($_GET['id_client']))
{
 if(!empty($_GET['id_client']))
 {
  ...
  $req_c = "select p.*,MATRICULEFISCALE,REFPERSONNE from client as c JOIN personne as p where p.ID = c.REFPERSONNE AND c.ID=".$id_client ;			
   ...
   <form id="new-customer" class="form-horizontal" method="post" action="" role="form">
    ...
    <div class="form-group form-actions">
     <div class="col-sm-offset-2 col-sm-10">
	  <a href="Modifier_Client.php" class="btn btn-default">Annuler</a>
